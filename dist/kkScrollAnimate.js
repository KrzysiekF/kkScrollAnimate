(function($) {
    ...
    $.fn.kkScrollAnimate = function(params) {
        ...
        var cssArgsBefore = {};
        cssArgsBefore[params.cssProperty] = params.before + 'vh';

        var cssArgsAfter = {};
        cssArgsAfter[params.cssProperty] = params.after + 'vh';
            ...
            function scrollAnimate() {
                ...
                if(scroll < params.startScroll) {
                    ...
                    if(params.cssProperty === 'add-class') {
                        ...
                        currentCss[params.cssProperty] = (params.before + (params.after - params.before) * scrollPercentage) + 'vh' ;
                        element.css(currentCss);
